...
module alu_tb;
    ...
    initial begin
        ...
        a = 64'h8000_0000_0000_0000; b = 64'h4000_0000_0000_0000; op = MULF;
        check_result("mulf -0*2", 64'h8000_0000_0000_0000);

        a = 64'h0000_0000_0000_0001; b = 64'h3FF0_0000_0000_0000; op = MULF;
        check_result("mulf sub*1", 64'h0000_0000_0000_0001);

        a = 64'h7FF0_0000_0000_0000; b = 64'hC000_0000_0000_0000; op = MULF;
        check_result("mulf inf*-2", 64'hFFF0_0000_0000_0000);

        a = 64'h7FF0_0000_0000_0000; b = 64'h0000_0000_0000_0000; op = MULF;
        check_result("mulf inf*0", 64'h7FF8_0000_0000_0000);
        ...
        a = 64'h8000_0000_0000_0000; b = 64'h4000_0000_0000_0000; op = DIVF;
        check_result("divf -0/2", 64'h8000_0000_0000_0000);

        a = 64'hBFF0_0000_0000_0000; b = 64'hFFF0_0000_0000_0000; op = DIVF;
        check_result("divf -1/-inf", 64'h0000_0000_0000_0000);

        a = 64'h7FF0_0000_0000_0000; b = 64'hC000_0000_0000_0000; op = DIVF;
        check_result("divf inf/-2", 64'hFFF0_0000_0000_0000);

        a = 64'h7FF0_0000_0000_0000; b = 64'h7FF0_0000_0000_0000; op = DIVF;
        check_result("divf inf/inf", 64'h7FF8_0000_0000_0000);

        a = 64'h0000_0000_0000_0001; b = 64'h3FF0_0000_0000_0000; op = DIVF;
        check_result("divf sub/1", 64'h0000_0000_0000_0001);
